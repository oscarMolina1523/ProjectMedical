  ...
  return (
    <div className="flex flex-col h-screen">
      <div className="flex flex-col h-1/4 items-center justify-center">
        <div className="text-dark-blue text-[2.5rem] font-bold text-extra-bold">Login here</div>
        <div className="text-dark-blue text-[1.1rem] font-bold">Bienvenido una vez mas!</div>
      </div>
      <div className="flex flex-col h-2/3 p-6 gap-4">
        ...
        <Link to="/register" className="w-full text-center">
          <span className="text-dark-blue mr-2 font-bold">Create new account</span>
        </Link>
      </div>
